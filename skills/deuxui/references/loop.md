...
setup is present. Then read `.deuxui/PRODUCT.md` and `.deuxui/DESIGN.md` if they
...
```bash
python3 scripts/ux_report.py --merge --feature forms > .deuxui/reports/agent_report.yaml
```
