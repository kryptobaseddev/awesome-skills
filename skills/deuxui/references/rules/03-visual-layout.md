...
| **LAY-006** | P1 | PROJECT | MUST preserve all essential information when converting a table or multi-column screen to a narrow layout. | The alternate representation retains labels, units, relationships, and actions. | S00 | `S-RESP-TABLE`, `R-TABLE-HIDDEN` |
