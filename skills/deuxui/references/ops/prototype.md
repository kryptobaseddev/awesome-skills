...
```bash
python3 scripts/ux_proto.py --write .deuxui/proto/index.html --title "Jobs"
```
...
```bash
python3 scripts/ux_proto.py --write .deuxui/proto/index.html   # panel included
...
HTML
python3 scripts/ux_proto.py --write .deuxui/proto/index.html --sections screens.html
python3 scripts/ux_proto.py --write .deuxui/proto/index.html --shell my-shell.html
```
...
python3 scripts/ux_review.py serve \
    --variant "proposed=.deuxui/proto/index.html" \
...
at — and written to `.deuxui/requests/REQ-NNN.yaml`. It appears in the agent's
