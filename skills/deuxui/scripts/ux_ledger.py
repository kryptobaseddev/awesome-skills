...
A decision was a file in `.deuxui/decisions/`, a note was a file in
`.deuxui/requests/`, the phase order was a list inside `phase.yaml`, and the
...
`design.contract.yaml` under its own sha in `.deuxui/contract/`, with a lineage
