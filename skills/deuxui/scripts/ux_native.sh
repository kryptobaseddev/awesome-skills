#!/usr/bin/env bash
# deuxui native runtime tier -- capture evidence from a Simulator, an emulator or
# a device, and record what was and was not available.
#
#   ux_native.sh --ios     [--out .deuxui/reports] [--udid UDID]   [--bundle ID]
#   ux_native.sh --android [--out .deuxui/reports] [--serial SER]  [--package ID]
#   ux_native.sh --both
#
