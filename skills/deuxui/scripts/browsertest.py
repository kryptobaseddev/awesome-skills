...
def main(argv=None) -> int:
    ...
    srv_log = Path(tempfile.gettempdir()) / f"deuxui-fixture-server-{a.port}.log"
    ...
    try:
        ...
        if shot is None:
            ...
            shot = Path(tempfile.gettempdir()) / "deuxui-fixture-fullpage.png"
        ...
        fc_out = Path(tempfile.mkdtemp(prefix="deuxui-fc-"))
        ...
        fc2 = Path(tempfile.mkdtemp(prefix="deuxui-fc2-"))
        ...
        ax_out = Path(tempfile.mkdtemp(prefix="deuxui-axe-"))
        ...
        for page, want in (("slow-good.html", "pass"), ("slow-bad.html", "fail")):
            sl_out = Path(tempfile.mkdtemp(prefix="deuxui-slow-"))
