...
written down.
  ...
  palette.py --check .deuxui/design.contract.yaml   # audit a declared palette

Why a tool. `deuxui design` told the agent to "commit to a world" and handed it
...
def check(contract_path: Path) -> int:
    ...
    if not contract_path.exists():
        sys.stderr.write(f"no contract at {contract_path}. Run `deuxui design` for new "
