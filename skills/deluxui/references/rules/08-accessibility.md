...
| **A11Y-006** | P1 | STANDARD | MUST expose relevant status messages programmatically without moving focus unnecessarily. | Assistive technology announces meaningful status without continuous redundant chatter. | S09 | `S-NAV-FOCUS-STEAL`, `M-SCREENREADER` |
