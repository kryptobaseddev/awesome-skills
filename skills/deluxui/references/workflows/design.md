...
Read `.deluxui/PRODUCT.md`, or write it (`init`). Then pick the visitor mode —
...
Copy `assets/templates/design.contract.yaml` to `.deluxui/design.contract.yaml` and fill
