...
in `.deluxui/design.contract.yaml` that the project declared, or to a question in
...
resolve it. With no `.deluxui/design.contract.yaml`, the conformance checks report
