...
Read `.deluxui/design.contract.yaml`. If `color.roles` is declared, this is a
...
`scripts/derive_contract.py --write` for existing code, `deluxui design` for new.
...
Paste the `color:` block into `.deluxui/design.contract.yaml`, including
