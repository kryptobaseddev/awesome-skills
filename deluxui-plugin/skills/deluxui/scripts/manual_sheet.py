...
"""Emit the manual tier as a sheet of questions, and report what is unanswered.
  ...
  manual_sheet.py --write         # write .deluxui/reports/manual.yaml if absent
...
DEFAULT = Path(".deluxui/reports/manual.yaml")
...
def sheet_text(existing: dict | None = None) -> str:
    ...
    lines = [
        "# deluxui manual tier -- the checks no machine settles.",
        "#",
