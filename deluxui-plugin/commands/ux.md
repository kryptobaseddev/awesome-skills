---
description: Route a UX request to the right deluxui operation, from measured signals rather than wording.
argument-hint: "[what you want, in your own words]"
---

The user said: $ARGUMENTS

Invoke the `deluxui` skill, then read `references/ops/routing.md` and follow it.
