...
```bash
python3 scripts/ux_proto.py --write .deluxui/proto/index.html --title "${1:-Prototype}"
python3 scripts/ux_check.py .deluxui/proto      # the generator must pass its own checks
```
