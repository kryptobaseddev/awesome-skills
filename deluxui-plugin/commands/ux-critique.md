...
Run the deluxui `critique` workflow on $ARGUMENTS.

Invoke the `deluxui` skill, then follow its `critique` workflow (`references/workflows/critique.md`). Produce the deterministic
