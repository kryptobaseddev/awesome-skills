...
than a review of somebody's taste.
    ...
    ux_proto.py --write .deuxui/proto/index.html
    ux_proto.py --write .deuxui/proto/index.html --title "Jobs" --density compact
    ux_proto.py                     # to stdout

Then put it in front of a person, beside whatever exists today:

    ux_review.py serve --variant "proposed=.deuxui/proto/index.html" \
...
_DOC = re.compile(r"<!--(?:(?!-->).)*?deuxui prototype shell.*?-->\s*", re.S)
