---
description: Set up .deuxui/ project memory by inspecting this repo.
---

Run the deuxui `init` workflow.

Invoke the `deuxui` skill, then follow its `init` workflow (`references/workflows/init.md`). Infer everything you can from the
