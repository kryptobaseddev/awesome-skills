...
Run the deuxui `create` workflow to build: $ARGUMENTS

Invoke the `deuxui` skill, then follow its `create` workflow (`references/workflows/create.md`). Before writing anything, run
