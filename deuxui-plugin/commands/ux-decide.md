...
Invoke the `deuxui` skill and read `references/ops/decide.md`.
...
```bash
python3 scripts/ux_question.py ask ${1:-.deuxui/comps/*.comps.yaml}
```
...
The answer lands in `.deuxui/decisions/DEC-NNN.yaml` with a hash of exactly what
